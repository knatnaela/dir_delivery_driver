...
class RideRepository implements RideRepositoryInterface {
  ...
  Future<Response> bidding(String tripId, String amount) async {
    return await apiClient.postData(AppConstants.bidding, {"trip_request_id": tripId, "bid_fare": amount});
  }
  ...
  Future<Response> uploadScreenShots(String id, XFile? file) async {
    ...
    return await apiClient.postMultipartData(
        AppConstants.uploadScreenShots, fields, [], MultipartBody('file', file), []);
  }
  ...
  Future<Response> tripAcceptOrReject(String tripId, String action) async {
    return await apiClient.postData(AppConstants.tripAcceptOrReject, {"trip_request_id": tripId, "action": action});
  }

  @override
  Future<Response> ignoreMessage(String tripId) async {
    return await apiClient.postData(AppConstants.tripAcceptOrReject, {"trip_request_id": tripId});
  }

  @override
  Future<Response> matchOtp(String tripId, String otp) async {
    return await apiClient.postData(AppConstants.matchOtp, {"trip_request_id": tripId, "otp": otp});
  }
  ...
  Future<Response> arrivalPickupPoint(String tripId) async {
    return await apiClient.postData(AppConstants.arrivalPickupPoint, {"trip_request_id": tripId, "_method": "put"});
  }

  @override
  Future<Response> arrivalDestination(String tripId, String destination) async {
    return await apiClient.postData(
        AppConstants.arrivedDestination, {"trip_request_id": tripId, "is_reached": destination, "_method": "put"});
  }

  @override
  Future<Response> waitingForCustomer(String tripId, String status) async {
    return await apiClient
        .postData(AppConstants.waitingUri, {"waiting_status": status, "trip_request_id": tripId, "_method": "put"});
  }

...
class ProfileLevelDetailsWidget extends StatelessWidget {
          ...
          ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if (profileController.levelModel?.data?.nextLevel != null)
                Center(
                  ...
                  const TextSpan(text: ' '),
                  TextSpan(
                    text: profileController.levelModel?.data?.nextLevel?.name,
                    style: textBold,
                  )
                ]))),
              const SizedBox(height: Dimensions.paddingSizeExtraSmall),
  ...
  double _calculateTotalTargetPoint(
      double targetedRidePoint, double targetedAmountPoint, double targetedCancelPoint, double targetedReviewPoint) {

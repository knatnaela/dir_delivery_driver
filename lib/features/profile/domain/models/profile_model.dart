...
class Vehicle {
  ...
  Vehicle.fromJson(Map<String, dynamic> json) {
    ...
    parcelWeightCapacity =
        json['parcel_weight_capacity'] == null ? null : double.tryParse('${json['parcel_weight_capacity']}');
  }
...
class TimeTrack {
  ...
  TimeTrack({this.id, this.date, this.totalOnline, this.totalOffline, this.totalIdle, this.totalDriving});

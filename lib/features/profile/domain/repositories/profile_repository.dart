...
class ProfileRepository implements ProfileRepositoryInterface {
  ...
  Future<Response?> addNewVehicle(VehicleBody vehicleBody, List<MultipartDocument> file) async {
    return await apiClient.postMultipartData(AppConstants.addNewVehicle, vehicleBody.toJson(), [], null, file);
  }
  ...
  Future<Response?> updateProfileInfo(
    ...
    return await apiClient.postMultipartData(
        AppConstants.updateProfileInfo, fields, identityImage!, MultipartBody('profile_image', profile), newDocuments);
  }

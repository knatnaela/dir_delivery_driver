...
import 'package:dir_delivery_driver/features/leaderboard/widgets/leader_board_card_widget.dart';
import 'package:dir_delivery_driver/features/leaderboard/widgets/today_leaderboard_status_widget.dart';
                      ...
                      ? leaderboardController.leaderBoardModel!.data != null &&
                          ...
                          ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  children: [
                                    if (leaderboardController.leaderBoardModel!.data!.length > 1)
                                      Expanded(
                                        ...
                                        index: 2,
                                        profile:
                                            leaderboardController.leaderBoardModel!.data![1].driver?.profileImage ?? '',
                                        name:
                              ...
                              PaginatedListViewWidget(
                                ...
                                offset: (leaderboardController.leaderBoardModel != null &&
                                        leaderboardController.leaderBoardModel!.offset != null)
                                    ? int.parse(leaderboardController.leaderBoardModel!.offset.toString())
                                    : null,
                                ...
                                itemView: ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    return LeaderBoardCardWidget(
                                        index: index,
                                        leaderBoard: leaderboardController.leaderBoardModel!.data![index]);
                                  },
                                ),
                              ),
                            ])
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Padding(
              padding:
                  const EdgeInsets.only(top: Dimensions.paddingSizeExtraSmall, bottom: Dimensions.paddingSizeSmall),
              child: Text('trips'.tr,
          ...
          Padding(
              ...
              child: ClipRRect(
                  ...
                  child: ImageWidget(
                    image: '${Get.find<SplashController>().config!.imageBaseUrl!.profileImage!}/$profile',
                    width: 50,
                    height: 50,
                  ))),
          Container(
            width: 100,
            decoration: BoxDecoration(color: color, borderRadius: BorderRadius.circular(Dimensions.paddingSizeSeven)),
            child: Padding(
              ...
              child: Column(children: [
                ...
                Padding(
                  ...
                  child: Center(
                    ...
                    maxLines: 2,
                    style: textSemiBold.copyWith(
                        color: index == 3 ? Theme.of(context).colorScheme.tertiaryContainer : Colors.white),
                  )),
                )
              ]),
            ),

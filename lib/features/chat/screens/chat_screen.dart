...
import 'package:dir_delivery_driver/features/chat/widgets/message_item_widget.dart';
                    ...
                    ? Expanded(
                        ...
                        child: PaginatedListViewWidget(
                          ...
                          offset: chatController.channelModel != null && chatController.channelModel!.offset != null
                              ? int.parse(chatController.channelModel!.offset.toString())
                              : 1,
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return channelUser != null
                                  ? MessageItemWidget(
                                      ...
                                      lastMessage:
                                          chatController.channelModel!.data![index].lastChannelConversations?.message ??
                                              '',

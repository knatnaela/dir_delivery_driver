...
class ConversationBubbleWidget extends StatefulWidget {
  ...
  const ConversationBubbleWidget(
      {super.key, required this.message, this.previousMessage, required this.index, required this.length});
  @override
      ...
      children: [
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            child: Container(
                                decoration: BoxDecoration(
                                    color: (widget.message.user!.id! == Get.find<ProfileController>().driverId)
                                        ? Theme.of(context).hintColor.withValues(alpha: 0.20)
                        ...
                        widget.message.conversationFiles!.isNotEmpty
                            ? SizedBox(
                                width:
                                    widget.message.conversationFiles!.length < 4 ? context.width : context.width * 0.53,
                                child: Directionality(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    itemBuilder: (BuildContext context, index) {
                                      return widget.message.conversationFiles![index].fileType == 'png' ||
                                              widget.message.conversationFiles![index].fileType == 'jpg'
                                          ? Padding(
                                          ...
                                          : InkWell(
                                              ...
                                              child: Container(
                                                  ...
                                                  child: Stack(children: [
                                                    Center(
                                                        child: SizedBox(width: 50, child: Image.asset(Images.folder))),
                                                    Center(
                                                        child: Text(
                                                            '${widget.message.conversationFiles![index].fileName}'
                                                                .substring(widget.message.conversationFiles![index]
                                                                        .fileName!.length -
                                                                    7),
                                                            maxLines: 5,
        ...
        Padding(
            ...
            child: Text(DateConverter.isoDateTimeStringToDifferentWithCurrentTime(widget.message.createdAt!),
                ...
                style:
                    textRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).hintColor))),

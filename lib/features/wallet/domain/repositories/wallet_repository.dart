...
class WalletRepository implements WalletRepositoryInterface {
  ...
  Future<Response?> convertPoint(String point) async {
    return await apiClient.postData(AppConstants.pointConvert, {'points': point});
  }
  ...
  Future<Response?> createWithdrawMethodInfo(List<String> typeKey, List<String> typeValue, int id) async {
    ...
    Response response = await apiClient.postData(AppConstants.withdrawMethodCreate, fields);

    return response;
  }

  @override
  Future<Response?> updateWithdrawMethodInfo(
      List<String> typeKey, List<String> typeValue, int methodId, String methodInfoId) async {
    Map<String, String> fields = {};
    ...
    Response response = await apiClient.postData('${AppConstants.withdrawMethodUpdate}$methodInfoId', fields);
  ...
  Future<Response?> deleteWithdrawMethodInfo(String methodId) async {
    Response response = await apiClient.postData('${AppConstants.withdrawMethodDelete}$methodId', {});
  ...
  Future<Response?> withdrawBalance(
      List<String> typeKey, List<String> typeValue, int id, String balance, String note) async {
    Map<String, String> fields = {};
    ...
    fields.addAll(<String, String>{'amount': balance, 'withdraw_method': id.toString(), 'note': note});

    Response response = await apiClient.postData(AppConstants.withdrawRequestUri, fields);

...
import 'package:dir_delivery_driver/features/wallet/screens/add_payment_info_screen.dart';
import 'package:dir_delivery_driver/features/wallet/screens/update_payment_info_screen.dart';
                      ...
                      ? walletController.withdrawMethodInfoData!.data!.isNotEmpty
                          ? SingleChildScrollView(
                              ...
                              child: PaginatedListViewWidget(
                                ...
                                offset: (walletController.withdrawMethodInfoData != null &&
                                        walletController.withdrawMethodInfoData?.offset != null)
                                    ? int.parse(walletController.withdrawMethodInfoData!.offset.toString())
                                    : null,
                                        ...
                                        child: Column(children: [
                                                    ...
                                                    showDialog(
                                                      ...
                                                      builder: (_) => DeleteConfirmationDialogWidget(
                                                          methodId: walletController
                                                              .withdrawMethodInfoData!.data![dataIndex].id),
                                                    );
                                                  }
                                                },
                                                itemBuilder: (context) => [
                                          ...
                                          Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                                            ...
                                            Expanded(
                                                ...
                                                child: Text(
                                                  walletController
                                                          .withdrawMethodInfoData?.data?[dataIndex].methodName ??
                                                      '',
                                          ...
                                          ListView.separated(
                                              itemCount: walletController
                                                      .withdrawMethodInfoData?.data?[dataIndex].methodInfo?.length ??
                                                  0,
                                              padding: EdgeInsets.zero,
                                              shrinkWrap: true,
                                              physics: const NeverScrollableScrollPhysics(),

...
import 'package:dir_delivery_driver/features/wallet/widgets/transaction_card_widget.dart';
...
class PayableTransactionListWidget extends StatefulWidget {
  ...
  const PayableTransactionListWidget({super.key, required this.walletController, required this.scrollController});
            ...
            ? Padding(
                ...
                child: PaginatedListViewWidget(
                  ...
                  offset: (widget.walletController.transactionModel != null &&
                      ...
                      ? int.parse(widget.walletController.transactionModel!.offset.toString())
                      : null,

...
class WithdrawRequestWidgetState extends State<WithdrawRequestWidget> {
                      ...
                      if (walletController.withdrawMethodInfoData != null)
                        Container(
                            ...
                            child: DropdownButton<SingleMethodInfo>(
                              ...
                              isExpanded: true,
                              hint:
                                  Text(walletController.selectedMethodInfo?.methodName ?? 'select_withdraw_method'.tr),
                              icon: Icon(Icons.arrow_drop_down_outlined),
                              padding: EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                              items: walletController.withdrawMethodInfoData!.data!
                                  .map((item) => DropdownMenuItem<SingleMethodInfo>(
                                        value: item,
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color: index == walletController.selectedIndex
                                          ? Theme.of(context).primaryColor
                                          : Colors.transparent,
                                      border: Border.all(
  ...
  void withdrawBalance() async {
    ...
    balance = _balanceController.text
        .trim()
        .replaceAll(Get.find<SplashController>().config?.currencySymbol ?? '\$', '')
        .replaceAll(' ', '')
        .replaceAll(',', '');

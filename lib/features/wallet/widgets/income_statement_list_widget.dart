...
import 'package:dir_delivery_driver/features/wallet/widgets/income_statement_card_widget.dart';
...
class _IncomeStatementListWidgetState extends State<IncomeStatementListWidget> {
  ...
  Widget build(BuildContext context) {
    return widget.walletController.incomeStatementData != null
        ? widget.walletController.incomeStatementData != null && widget.walletController.incomeStatementData!.isNotEmpty
            ? Padding(
                ...
                child: PaginatedListViewWidget(
                  ...
                  offset: (widget.walletController.incomeStatement != null &&
                      ...
                      ? int.parse(widget.walletController.incomeStatement!.offset.toString())
                      : null,

    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
            decoration:
                BoxDecoration(color: Theme.of(context).colorScheme.error, borderRadius: BorderRadius.circular(100)),
            child: Padding(
          ...
          if (!fromFailed) ...[
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              ...
              InkWell(
                onTap: () => Get.find<WalletController>().deleteWithdrawMethodInfo(methodId ?? ''),
                child: Container(
                  width: Get.width * 0.3,
                  height: Get.height * 0.05,
                  decoration: BoxDecoration(

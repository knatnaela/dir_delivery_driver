        ...
        body: Center(
          child: Padding(
            ...
            child: Column(children: [
              ...
              ButtonWidget(
                buttonText:
                    '${'download_new_version'.tr} (${Platform.isAndroid ? Get.find<SplashController>().config?.androidAppMinimumVersion : Get.find<SplashController>().config?.iosAppMinimumVersion})',
                onPressed: () {

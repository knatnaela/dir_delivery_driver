          ...
          child: Container(
            ...
            child: Center(
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                if (configModel != null) ...[
                  if (configModel.maintenanceMode?.maintenanceMessages?.maintenanceMessage != null &&
                      configModel.maintenanceMode!.maintenanceMessages!.maintenanceMessage!.isNotEmpty) ...[
                    Text(
                      configModel.maintenanceMode?.maintenanceMessages?.maintenanceMessage ?? "",
                  ...
                  if (configModel.maintenanceMode?.maintenanceMessages?.messageBody != null &&
                      configModel.maintenanceMode!.maintenanceMessages!.messageBody!.isNotEmpty) ...[
                    Text(
                      configModel.maintenanceMode?.maintenanceMessages?.messageBody ?? "",
                      textAlign: TextAlign.center,
                      style: textMedium.copyWith(
                  ...
                  if (configModel.maintenanceMode?.maintenanceMessages?.businessEmail == 1 ||
                    ...
                    if ((configModel.maintenanceMode?.maintenanceMessages?.maintenanceMessage != null &&
                            configModel.maintenanceMode!.maintenanceMessages!.maintenanceMessage!.isNotEmpty) ||
                        (configModel.maintenanceMode?.maintenanceMessages?.messageBody != null &&
                            configModel.maintenanceMode!.maintenanceMessages!.messageBody!.isNotEmpty)) ...[
                      Row(

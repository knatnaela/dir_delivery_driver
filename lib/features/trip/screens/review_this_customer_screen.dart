...
import 'package:dir_delivery_driver/features/trip/widgets/header_title_widget.dart';
    ...
    return SafeArea(
      ...
      child: PopScope(
        ...
        child: Scaffold(
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          enabledBorder: OutlineInputBorder(
                            ...
                            borderSide:
                                BorderSide(width: 0.5, color: Theme.of(context).hintColor.withValues(alpha: 0.5)),
                          ),
                          focusedBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                            borderSide:
                                BorderSide(width: 0.5, color: Theme.of(context).primaryColor.withValues(alpha: 0.5)),
                          ),
                        ),
                      ),
                    ],
          ...
          bottomNavigationBar: GetBuilder<ReviewController>(builder: (reviewController) {
            return Padding(

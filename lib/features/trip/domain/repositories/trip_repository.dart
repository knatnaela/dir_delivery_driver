...
class TripRepository implements TripRepositoryInterface {
  ...
  Future<Response> getTripList(
      String tripType, String from, String to, int offset, String filter, String status) async {
    return await apiClient
        .getData('${AppConstants.tripList}?type=$tripType&limit=10&offset=$offset&filter=$filter&status=$status');
  }
  ...
  Future resendReturnedOtp(String tripId) async {
    return await apiClient.postData(AppConstants.parcelResendOtp, {"trip_request_id": tripId, "_method": 'put'});
  }

  @override
  Future parcelReturnSubmitOtp(String tripId, String otp) async {
    return await apiClient
        .postData(AppConstants.parcelReturnedOtp, {"trip_request_id": tripId, "otp": otp, "_method": 'put'});
  }

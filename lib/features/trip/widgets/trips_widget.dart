...
import 'package:dir_delivery_driver/features/trip/widgets/trip_card_widget.dart';
                ...
                ? SingleChildScrollView(
                    ...
                    child: Padding(
                      ...
                      child: PaginatedListViewWidget(
                        ...
                        offset:
                            (widget.tripController.tripModel != null && widget.tripController.tripModel!.offset != null)
                                ? int.parse(widget.tripController.tripModel!.offset.toString())
                                : 1,
                        onPaginate: (int? offset) async {
                          if (kDebugMode) {
                            print('==========offset========>$offset');
                          }
                          await widget.tripController.getTripList(offset!, '', '', 'ride_request',
                              widget.tripController.selectedFilterTypeName, widget.tripController.selectedStatusName);
                        },
                        itemView: ListView.separated(
                          ...
                          separatorBuilder: (BuildContext context, int index) =>
                              Divider(color: Theme.of(context).highlightColor.withValues(alpha: 0.15)),
                        ),
                      ),
                    ),
                  )

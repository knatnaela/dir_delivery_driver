...
import 'package:dir_delivery_driver/features/trip/widgets/chart_widget.dart';
import 'package:dir_delivery_driver/common_widgets/title_widget.dart';
        ...
        child: GetBuilder<TripController>(builder: (tripController) {
          return Stack(children: [
            Column(children: [
              ...
              ReportsItemCard(
                  title: 'total_trip_amount', amount: tripController.tripOverView?.totalEarn ?? 0, isTotal: true),
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          isTotal
              ? Text(PriceConverter.convertPrice(context, amount!),
                  style: textRobotoMedium.copyWith(color: Theme.of(context).primaryColor))
              : isReview

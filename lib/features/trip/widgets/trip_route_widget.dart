...
import 'package:dir_delivery_driver/common_widgets/custom_divider_widget.dart';
            ...
            child: Column(children: [
              Container(
                ...
                child: Image.asset(Images.currentLocation,
                    color: Theme.of(context).textTheme.bodyMedium?.color, width: Dimensions.iconSizeMedium),
              ),
              if ((extraOne != null && extraOne!.isNotEmpty) || (extraTwo != null && extraTwo!.isNotEmpty))
                const SizedBox(
                    height: 25, width: 10, child: CustomDivider(height: 2, dashWidth: 1, axis: Axis.vertical)),
              if ((extraOne != null && extraOne!.isNotEmpty) || (extraTwo != null && extraTwo!.isNotEmpty))
          ...
          Expanded(
            ...
            if ((extraOne != null && extraOne!.isNotEmpty) || (extraTwo != null && extraTwo!.isNotEmpty))
              const Padding(
                ...
                child:
                    SizedBox(height: 20, width: 10, child: CustomDivider(height: 2, dashWidth: 1, axis: Axis.vertical)),
              ),
            ...
            if (extraOne != null || extraTwo != null) const SizedBox(height: Dimensions.paddingSizeSmall),
            Padding(
            ...
            if (entrance != null && entrance!.isNotEmpty) Divider(color: Theme.of(context).hintColor),

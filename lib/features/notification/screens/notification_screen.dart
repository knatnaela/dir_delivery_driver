...
import 'package:dir_delivery_driver/features/notification/widgets/notification_card_widget.dart';
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        return NotificationCardWidget(
                                          previousNotification: index == 0
                                              ? null
                                              : notificationController.notificationModel!.data![index - 1],
                                          notification: notificationController.notificationModel!.data![index],
                                          nextNotification:
                                              (index == notificationController.notificationModel!.data!.length - 1)
                                                  ? null
                                                  : notificationController.notificationModel!.data![index + 1],
                                          index: index,
                                        );

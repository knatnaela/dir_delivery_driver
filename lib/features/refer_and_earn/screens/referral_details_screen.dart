...
import 'package:dir_delivery_driver/features/refer_and_earn/widgets/referral_earn_bottomsheet_widget.dart';
        ...
        return (Get.find<SplashController>().config?.referralEarningStatus ?? false)
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          Align(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                  color: Theme.of(context).cardColor.withValues(alpha: 0.75), shape: BoxShape.circle),
                  ...
                  Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      InkWell(
                        onTap: () {
                          Clipboard.setData(
                                  ClipboardData(text: referAndEarnController.referralDetails?.data?.referralCode ?? ''))
                              .then((_) {
            ...
            : Column(children: [
                ...
                Padding(
                  ...
                  child: Text('our_refer_and_earn_program_is_temporarily_paused'.tr,
                      textAlign: TextAlign.center,
                      style: textRegular.copyWith(

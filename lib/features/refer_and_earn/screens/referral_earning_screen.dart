...
import 'package:dir_delivery_driver/features/refer_and_earn/widgets/custom_itle.dart';
import 'package:dir_delivery_driver/features/refer_and_earn/widgets/earning_card_widget.dart';
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(
                      PriceConverter.convertPrice(
                          context, Get.find<ProfileController>().profileInfo?.wallet?.referralEarn ?? 0),
                      style: textRobotoBold.copyWith(color: Theme.of(context).primaryColor, fontSize: 20))
                ]),
                ...
                ? (referAndEarnController.referralModel!.data!.isNotEmpty)
                    ? Expanded(
                        ...
                        child: PaginatedListViewWidget(
                          ...
                          offset: (referAndEarnController.referralModel?.offset != null)
                              ? int.parse(referAndEarnController.referralModel!.offset.toString())
                              : null,

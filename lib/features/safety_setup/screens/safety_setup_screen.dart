      ...
      child: Scaffold(
        ...
        body: GetBuilder<SafetyAlertController>(builder: (safetyAlertController) {
          return Padding(
            ...
            child:
                Column(spacing: Dimensions.paddingSizeSmall, crossAxisAlignment: CrossAxisAlignment.start, children: [
              Container(
                width: Get.width,
                ...
                child: Column(spacing: Dimensions.paddingSizeSmall, children: [
                  ...
                  Padding(
                    ...
                    child: Text('when_you_make_a_call_or_send_ext'.tr,
                        style: textRegular.copyWith(fontSize: 10), textAlign: TextAlign.center),
                  )
                ]),
              ),
                          ...
                          return Container(
                            ...
                            child: ExpansionTile(
                              ...
                              title: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Flexible(
                                    child: Text('${safetyAlertController.precautionListModel?.data?[index].title}',
                                        style: textRegular.copyWith(
                                            color: Theme.of(context).textTheme.bodyMedium?.color))),
                              ]),
                              shape: Border(),

        ...
        child: Padding(
          ...
          child: Column(
              ...
              children: [
                ...
                Text('here_a_list_of_number_that_you'.tr,
                    style:
                        textRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor)),
                Flexible(
                  child: Container(
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          onTap: () => launchUrl(Uri.parse(
                              "tel: ${safetyAlertController.otherEmergencyNumberModel?.data?[index].number}")),
                          child: Padding(

...
import 'package:dir_delivery_driver/common_widgets/animated_wifi/animated_wifi_widget.dart';
...
class StayOnlineWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProfileController>(initState: (val) {
      ...
      return Padding(
        padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeDefault, top: Dimensions.paddingSize),
        child: Column(children: [
          ...
          Container(
              padding: EdgeInsets.only(top: Get.height * 0.005, left: Get.width * 0.03),
              height: 80,
              width: 100,
              child: const WifiAnimations()),
          Padding(
              padding:
                  const EdgeInsets.only(top: Dimensions.paddingSizeDefault, bottom: Dimensions.paddingSizeExtraSmall),

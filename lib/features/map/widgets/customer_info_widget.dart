...
class CustomerInfoWidget extends StatelessWidget {
  ...
  const CustomerInfoWidget(
      {super.key, this.fromTripDetails = false, required this.customer, this.fare, this.customerRating});
              ...
              if (customerRating != null && customerRating!.isNotEmpty)
                Row(children: [
                  Icon(Icons.star_rate_rounded,
                      color: Theme.of(Get.context!).colorScheme.primaryContainer, size: Dimensions.iconSizeMedium),

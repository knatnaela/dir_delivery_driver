                    ...
                    children: [
                      Text(widget.name,
                          style: textMedium.copyWith(
                              fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColorDark),
                          overflow: TextOverflow.ellipsis),
                      Text(
                        widget.contactNumber,
                        style:
                            textMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor),
                        overflow: TextOverflow.ellipsis,
                      ),
                    ],
                  )

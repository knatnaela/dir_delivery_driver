          ...
          InkWell(
            ...
            child: Container(
              padding: const EdgeInsets.symmetric(
                  vertical: Dimensions.paddingSizeTiny, horizontal: Dimensions.paddingSizeSeven),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
                  color: currentSelectedAPIndex == 1 ? Theme.of(context).primaryColor : Colors.transparent),
              child: Text('am',
                  style: textRegular.copyWith(color: currentSelectedAPIndex == 1 ? Theme.of(context).cardColor : null)),
            ),
          ),
          InkWell(
            onTap: () {
            ...
            child: Container(
              ...
              child: Text('pm',
                  style: textRegular.copyWith(color: currentSelectedAPIndex == 2 ? Theme.of(context).cardColor : null)),
            ),
          )
        ]),
      ));

...
class DropDownWidgetState extends State<DropDownWidget> with WidgetsBindingObserver {
                      ...
                      Padding(
                        ...
                        child: Container(
                          constraints: BoxConstraints(
                              maxHeight: widget.maxListHeight, maxWidth: widget.menuItemWidth ?? size.width),
  ...
  Offset getOffset() {
    ...
    if (spaceAvailable > widget.maxListHeight) {
      _isReverse = false;
      return Offset(
          widget.showLeftSide ? 0 : renderBox.size.width - (widget.menuItemWidth ?? 0), renderBox.size.height);
    } else {
      _isReverse = true;
      return Offset(widget.showLeftSide ? 0 : renderBox.size.width - (widget.menuItemWidth ?? 0),

...
import 'package:dir_delivery_driver/common_widgets/time_picker_spinner.dart';
      ...
      child: Row(
        ...
        children: [
          ...
          TimePickerSpinner(
            ...
            isForce2Digits: true,
            onTimeChange: (time) {
              Get.find<TripController>().setParcelReturnTime(
                  "${time.hour >= 10 ? '' : '0'}${time.hour}:${time.minute >= 10 ? '' : '0'}${time.minute}:${time.second >= 10 ? '' : '0'}${time.second}");
            },
          )
        ],
      ),

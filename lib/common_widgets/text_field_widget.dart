...
import 'package:dir_delivery_driver/common_widgets/country_picker_widget.dart';
      ...
      decoration: InputDecoration(
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
              width: widget.showBorder ? 0.5 : 0.5, color: Theme.of(context).hintColor.withValues(alpha: 0.5)),
        ),
        ...
        filled: true,
        contentPadding:
            EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall, vertical: widget.isEnabled ? 0 : 13),
            ...
            ? Container(
                ...
                child: Center(
                  child: Image.asset(widget.prefixIcon!,
                      height: 20, width: 20, color: widget.prefixIconColor ?? Theme.of(context).hintColor),
                ),
              )
            : SizedBox(
                width: widget.showCountryCode ? Get.width * 0.27 : 80,
                child: Row(
                  children: [
                    Container(
                      width: widget.prefixHeight,

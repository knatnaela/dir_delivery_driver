...
class _CustomDatePickerState extends State<CustomDatePicker> {
  @override
  void initState() {
    Get.find<TripController>().setParcelReturnDate(
        DateFormat('yyyy-MM-dd').format(Get.find<SplashController>().config!.parcelReturnTimeFeeStatus!
    ...
    return Container(
        ...
        child: SfDateRangePicker(
            ...
            monthCellStyle: DateRangePickerMonthCellStyle(
                todayTextStyle: TextStyle(color: Theme.of(context).textTheme.bodyLarge!.color!))));
  }
}

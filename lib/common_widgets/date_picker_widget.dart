          ...
          text: TextSpan(
            ...
            children: <TextSpan>[
              widget.requiredField
                  ? TextSpan(
                      text: '  *', style: textBold.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color!))
                  : const TextSpan(),
            ],
          ),
        ),
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          InkWell(
            ...
            child: SizedBox(
                ...
                height: 20,
                child:
                    CustomAssetImageWidget(widget.image, color: widget.imageColor ?? Theme.of(context).primaryColor)),
          ),
        ]),
      ),
    ]);
